...
class DinnerModel {
    ...
    /**
     * Get all items from the dinner menu.
     *
     * @return array An array containing the dinner menu items.
     */
    public function getDinnerMenu(): array {
        $conn = $this->conn;
        $result = [];  // Initialize an empty array

        // Perform the query and populate $result with data
        $query = "SELECT * FROM dinner_menu";
    ...
    /**
     * Create a new menu item in the dinner menu.
     *
     ...
     */
     public function createMenu($name, $price, $image)
     {
         ...
         $sql = "INSERT INTO dinner_menu (name, price, image) VALUES (?, ?, ?)";
    ...
    /**
     * Read a menu item from the dinner menu by its ID.
     *
    ...
    public function readMenuById($id)
    {
        ...
        $sql = "SELECT * FROM dinner_menu WHERE item_id = ?";
        $stmt = $con->prepare($sql);
    ...
    /**
     * Update a menu item in the dinner menu.
     *
    ...
    public function update($item_id, $name, $price, $image)
    {
        ...
        $sql = "UPDATE dinner_menu SET name=?, price=?, image=? WHERE item_id=?";
        $stmt = $con->prepare($sql);
    ...
    /**
     * Delete a menu item from the dinner menu by its ID.
     *
    ...
    public function delete($id)
    {
        ...
        $sql = "DELETE FROM dinner_menu WHERE item_id=?";
        $stmt = $con->prepare($sql);
        $stmt->bind_param("i", $id);
