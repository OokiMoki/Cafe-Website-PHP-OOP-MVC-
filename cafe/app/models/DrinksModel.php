...
class DrinksModel {
    ...
    /**
     * Get all items from the drinks menu.
     *
     * @return array An array containing the drinks menu items.
     */
    public function getDrinksMenu(): array {
        $conn = $this->conn;
        $result = [];  // Initialize an empty array

        // Perform the query and populate $result with data
        $query = "SELECT * FROM drinks_menu";
    ...
    /**
     * Create a new menu item in the drinks menu.
     *
    ...
    public function createMenu($name, $price, $image)
    {
        ...
        $sql = "INSERT INTO drinks_menu (name, price, image) VALUES (?, ?, ?)";
    ...
    /**
     * Read a menu item from the drinks menu by its ID.
     *
    ...
    public function readMenuById($id)
    {
        ...
        $sql = "SELECT * FROM drinks_menu WHERE item_id = ?";
        $stmt = $con->prepare($sql);
    ...
    /**
     * Update a menu item in the drinks menu.
     *
    ...
    public function update($item_id, $name, $price, $image)
    {
        ...
        $sql = "UPDATE drinks_menu SET name=?, price=?, image=? WHERE item_id=?";
        $stmt = $con->prepare($sql);
    ...
    /**
     * Delete a menu item from the drinks menu by its ID.
     *
    ...
    public function delete($id)
    {
        ...
        $sql = "DELETE FROM drinks_menu WHERE item_id=?";
        $stmt = $con->prepare($sql);
        $stmt->bind_param("i", $id);
