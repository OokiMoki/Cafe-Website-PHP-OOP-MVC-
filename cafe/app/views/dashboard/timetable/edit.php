...
<body>
    ...
    <div class="container mt-5">
        <div class="bg-primary p-2 rounded-2 text-white">
            ...
            <span class="small ms-4">Timetable > Update</span>
        </div>
        ...
        <div class="mt-4">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <form action="/app/core/timetable/update_process.php" method="post" >
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="employee_id" name="employee_id" required>
                                ...
                                ?>
                                    <option value="<?php echo $employee['employee_id'] ?>" <?php echo $data['employee_id'] == $employee['employee_id'] ? 'selected' : '' ?>><?php echo $employee['first_name'] . ' ' . $employee['last_name'] .' - ' . $employee['role'] ?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="start_date" name="start_date" value="<?php echo htmlspecialchars($data['start_date']); ?>" required>
                        </div>

                        <!-- Start Time -->
                        <div class="mb-3">
                            <label for="start_time" class="form-label">Start Time</label>
                            <input type="time" class="form-control" id="start_time" name="start_time" value="<?php echo htmlspecialchars($data['start_time']); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="date" class="form-label">End Date</label>
                            <input type="date" class="form-control" id="end_date" name="end_date" value="<?php echo htmlspecialchars($data['end_date']); ?>" required>
                        </div>
                        <!-- End Time -->
                        <div class="mb-3">
                            <label for="end_time" class="form-label">End Time</label>
                            <input type="time" class="form-control" id="end_time" name="end_time" value="<?php echo htmlspecialchars($data['end_time']); ?>" required>
                        </div>
                        <div class="text-end">
